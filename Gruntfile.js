module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        babel: {
            ...
            dist: {
                files: {
                    '<%= settings.distPath %>js/<%= settings.library %>.js': ['<%= settings.srcPath %>js/<%= settings.library %>.js']
                }
            }
        },
        ...
        uglify: {
            build: {
                ...
                files: {
                    '<%= settings.distPath %>js/<%= settings.library %>.min.js': ['<%= settings.distPath %>js/<%= settings.library %>.js']
                }
            }
        },
